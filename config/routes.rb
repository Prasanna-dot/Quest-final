...
Rails.application.routes.draw do
  ...
  get 'assessment', to: 'home#assessment', as: 'assessment'
  resources :users
  resources :answers
  ...
  get 'question/:title', to: 'questions#index', as: 'create'
  ...
  get 'questions/:id', to: 'questions#destroy', as: :destroy
  get 'dashboard/:title', to: 'home#dashboard', as: :dashboard
  get 'dashboard/:btn/:titl', to: 'home#dashboard', as: :dashboard
  get 'interview', to: 'home#interview', as: :interview
